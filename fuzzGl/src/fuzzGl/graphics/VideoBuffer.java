...
*/
    public void init()//int m_x,int m_y,int swapId,boolean bufferIdB, int postFilter)
    {
...
//            bufferCurrent = new int[xSize * ySize];
    ...
    public final void postProd()
    {
        if (0 != postFilterId) 
        {
            ...
            {
                case 1:
                    PostProcessing.filter01(this);
                    break;
                case 2:
                    PostProcessing.filter02(this);
                    break;
                case 3:
                    PostProcessing.filter03(this);
                    break;
                case 4:
                    PostProcessing.filter04(this);
                    break;
            }
        }
    }
