...
public class Simple2CubesDepthRange extends SamplesBase
{
    int m_width=0;
    int m_height=0;
    static double r=0.0;
    ...
    public void update()
    {
        ...
        c.glDepthRange(0.0,0.5);

        c.glTranslated(1,0,0);
        c.glRotated(r,0.0,0.0,1.0);
        c.glRotated(r*2,1.0,0.0,1.0);
//        c.glScaled(1.5,1.5,1.5);
        drawCube();
        c.glPopMatrix();

        c.glDepthRange(0.9,1.0);

        c.glPushMatrix();
        c.glTranslated(-1,0,0);
        c.glRotated(r*2,0.0,1.0,1.0);
        c.glRotated(r,1.0,0.0,1.0);
